 ...
 <View style={styles.doctorBox}>
  ...
  <View style={{width:'90%',alignItems:'center'}}>
   <View style={styles.docAppoint}>
      ...
      <Image source={require('../../../assets/warning.png')} resizeMode='contain' style={{width:scale(25),height:scale(30),marginBottom:scale(33)}}/>
      <Text style={{fontSize:scale(16),color:'#AE7D59',letterSpacing:scale(.5),paddingHorizontal:scale(10)}}> Reservation must be confirmed by payment at the clinic one day before appointment.</Text>
      </View>
