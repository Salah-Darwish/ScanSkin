...
export default function NotificationDoctors() {
  const [arr,setArr]=useState([{id:1,text:'You set a reminder for appointment with Omar Ali today.'},
  {id:1,text:'You set a reminder for appointment with Omar Ali today.'},
  {id:1,text:'You set a reminder for appointment with Omar Ali today.'},
  ])
  return (
...
<View style={styles.today}>
      ...
      <View style={styles.notifyBox}>
        ...
        <Text style={{fontSize:scale(15),color:colors.backgr,textAlign:'center',paddingHorizontal:scale(5)}}> You set a reminder for appointment with Omar Ali today.</Text>
      </View>
      <View style={styles.notifyBox1}>
        ...
        <Text style={{fontSize:scale(15),color:colors.Actdot,textAlign:'center',paddingHorizontal:scale(5)}}> You set a reminder for appointment with Hassan Ali today.</Text>
      </View>
      <View style={{marginTop:scale(25),paddingHorizontal:scale(10)}}>
  ...
  notifyBox: {
    ...
    borderRadius: scale(15),
    shadowRadius: scale(8),
    shadowOffset: { width: scale(56), height: verticalScale(13) },
